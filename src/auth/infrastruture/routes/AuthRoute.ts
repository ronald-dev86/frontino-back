...
export class AuthRoute {
    ...
    private resetPasswordController = new ResetPasswordController();
    ...
    private initializeRoutes() {
        ...
        this.router.post(`${this.path}/resetPassword`, AuthTokenMiddleware , (req, res, next) => {this.resetPasswordController.run(req, res)});
    }
}